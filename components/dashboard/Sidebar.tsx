...
import {
  ...
  LogOut, Zap, ChevronLeft, ChevronRight, Mic,
} from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className={`hidden md:flex flex-col h-screen sticky top-0 glass-dark border-r border-white/06 transition-all duration-300 ${
        collapsed ? 'w-20' : 'w-64'
      }`}
    >
      {/* Logo */}
