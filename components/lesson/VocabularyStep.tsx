...
const defaultWords: Word[] = [
  {
    ...
    definition: 'The quality or condition of being able to speak or write a language easily and accurately.',
    example: 'His fluency in English is impressive.',
    translation: 'Беглость, свободное владение',
  },
]

export default function VocabularyStep({ onComplete, words = defaultWords }: VocabularyStepProps) {
  ...
  const card = currentWords[cardIndex] || currentWords[0]
  const progress = Math.round((cardIndex / currentWords.length) * 100)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-white/50">{cardIndex + 1} of {currentWords.length} words</p>
        </div>
